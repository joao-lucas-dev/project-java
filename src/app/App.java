...
public class App {
    ...
    public static int count_Quick_5 = 0;
    public static int count_Quick_10 = 0;
    public static int count_Quick_50 = 0;
    public static int count_Quick_100 = 0;
    public static int count_Quick_1000 = 0;
    public static int count_Quick_10000 = 0;
    ...
    public static void substituir(int Array[], int i, int j) {
        int a;
    ...
    public static int separar(int Array[], int esq, int dir) {
        int pivo, i, j;
        ...
        while (i < j) {
            /*
             * Executará o loop enquanto a ouver elementos do vetor a direita maiores que o
             * pivo
             */
            do {
                j -= 1;
            ...
            /*
             * Executará o loop enquanto a ouver elementos do vetor a esquerda menores que o
             * pivo
             */
            do {
                i += 1;
            ...
            /*
             * iniciará a função substituir quando a variavel auxiliar i for maior que a
             * variavel auxiliar j
             */
            if (i < j) {
                substituir(Array, i, j);
            }
        }
        return j;
    }

    public static int quickSort(int Array[], int esq, int dir) {
        int q, i, c = 0;
        /*
         * inicia a comparação entre os valores na primeira e ultima posição do vetor
         */
        if (esq < dir) {
            /* inicia o metodo separar */
            q = separar(Array, esq, dir);
            /*
             * por meio de recursão faz a releitura do metodo quickSort para cada novo
             * membro criado apos a separação do vetor inicial desta vez com os elementos a
             * esquerda do pivô e em seguida com os elementos a direita do pivô
             */
            quickSort(Array, esq, q);
            quickSort(Array, q + 1, dir);
            c++;
        }
        return c;
    }

    static void exibeOrdenado(int Array[]) {
    ...
    public static void main(String[] args) {
        ...
        // Bubble
        // Calcula a média de comparações: (comparacao1 + comparacao2 + ... +
        // comparacao8) / 8
        ...
        // Array[5]
        System.out.println("----------------ARRAY[5]-------------------");
        count_Quick_5 += quickSort(vt_tam_5_1, 0,vt_tam_5_1.length-1);
        exibeOrdenado(vt_tam_5_1);
        count_Quick_5 += quickSort(vt_tam_5_2, 0,vt_tam_5_2.length-1);
        exibeOrdenado(vt_tam_5_2);
        count_Quick_5 += quickSort(vt_tam_5_3, 0,vt_tam_5_3.length-1);
        exibeOrdenado(vt_tam_5_3);
        count_Quick_5 += quickSort(vt_tam_5_4, 0,vt_tam_5_4.length-1);
        exibeOrdenado(vt_tam_5_4);
        count_Quick_5 += quickSort(vt_tam_5_5, 0,vt_tam_5_5.length-1);
        exibeOrdenado(vt_tam_5_5);
        count_Quick_5 += quickSort(vt_tam_5_6, 0,vt_tam_5_6.length-1);
        exibeOrdenado(vt_tam_5_6);
        count_Quick_5 += quickSort(vt_tam_5_7, 0,vt_tam_5_7.length-1);
        exibeOrdenado(vt_tam_5_7);
        count_Quick_5 += quickSort(vt_tam_5_8, 0,vt_tam_5_8.length-1);
        exibeOrdenado(vt_tam_5_8);

        // Array[10]
        System.out.println("----------------ARRAY[10]-------------------");
        count_Quick_10 += quickSort(vt_tam_10_1, 0,vt_tam_10_1.length-1);
        exibeOrdenado(vt_tam_10_1);
        count_Quick_10 += quickSort(vt_tam_10_2, 0,vt_tam_10_2.length-1);
        exibeOrdenado(vt_tam_10_2);
        count_Quick_10 += quickSort(vt_tam_10_3, 0,vt_tam_10_3.length-1);
        exibeOrdenado(vt_tam_10_3);
        count_Quick_10 += quickSort(vt_tam_10_4, 0,vt_tam_10_4.length-1);
        exibeOrdenado(vt_tam_10_4);
        count_Quick_10 += quickSort(vt_tam_10_5, 0,vt_tam_10_5.length-1);
        exibeOrdenado(vt_tam_10_5);
        count_Quick_10 += quickSort(vt_tam_10_6, 0,vt_tam_10_6.length-1);
        exibeOrdenado(vt_tam_10_6);
        count_Quick_10 += quickSort(vt_tam_10_7, 0,vt_tam_10_7.length-1);
        exibeOrdenado(vt_tam_10_7);
        count_Quick_10 += quickSort(vt_tam_10_8, 0,vt_tam_10_8.length-1);
        exibeOrdenado(vt_tam_10_8);

        // Array[50]
        System.out.println("----------------ARRAY[50]-------------------");
        count_Quick_50 += quickSort(vt_tam_50_1, 0,vt_tam_50_1.length-1);
        exibeOrdenado(vt_tam_50_1);
        count_Quick_50 += quickSort(vt_tam_50_2, 0,vt_tam_50_2.length-1);
        exibeOrdenado(vt_tam_50_2);
        count_Quick_50 += quickSort(vt_tam_50_3, 0,vt_tam_50_3.length-1);
        exibeOrdenado(vt_tam_50_3);
        count_Quick_50 += quickSort(vt_tam_50_4, 0,vt_tam_50_4.length-1);
        exibeOrdenado(vt_tam_50_4);
        count_Quick_50 += quickSort(vt_tam_50_5, 0,vt_tam_50_5.length-1);
        exibeOrdenado(vt_tam_50_5);
        count_Quick_50 += quickSort(vt_tam_50_6, 0,vt_tam_50_6.length-1);
        exibeOrdenado(vt_tam_50_6);
        count_Quick_50 += quickSort(vt_tam_50_7, 0,vt_tam_50_7.length-1);
        exibeOrdenado(vt_tam_50_7);
        count_Quick_50 += quickSort(vt_tam_50_8, 0,vt_tam_50_8.length-1);
        exibeOrdenado(vt_tam_50_8);

        // Array[100]
        System.out.println("----------------ARRAY[100]-------------------");
        count_Quick_100 += quickSort(vt_tam_100_1, 0,vt_tam_100_1.length-1);
        exibeOrdenado(vt_tam_100_1);
        count_Quick_100 += quickSort(vt_tam_100_2, 0,vt_tam_100_2.length-1);
        exibeOrdenado(vt_tam_100_2);
        count_Quick_100 += quickSort(vt_tam_100_3, 0,vt_tam_100_3.length-1);
        exibeOrdenado(vt_tam_100_3);
        count_Quick_100 += quickSort(vt_tam_100_4, 0,vt_tam_100_4.length-1);
        exibeOrdenado(vt_tam_100_4);
        count_Quick_100 += quickSort(vt_tam_100_5, 0,vt_tam_100_5.length-1);
        exibeOrdenado(vt_tam_100_5);
        count_Quick_100 += quickSort(vt_tam_100_6, 0,vt_tam_100_6.length-1);
        exibeOrdenado(vt_tam_100_6);
        count_Quick_100 += quickSort(vt_tam_100_7, 0,vt_tam_100_7.length-1);
        exibeOrdenado(vt_tam_100_7);
        count_Quick_100 += quickSort(vt_tam_100_8, 0,vt_tam_100_8.length-1);
        exibeOrdenado(vt_tam_100_8);

        // Array[1000]
        System.out.println("----------------ARRAY[1000]-------------------");
        count_Quick_1000 += quickSort(vt_tam_1000_1, 0,vt_tam_1000_1.length-1);
        exibeOrdenado(vt_tam_1000_1);
        count_Quick_1000 += quickSort(vt_tam_1000_2, 0,vt_tam_1000_2.length-1);
        exibeOrdenado(vt_tam_1000_2);
        count_Quick_1000 += quickSort(vt_tam_1000_3, 0,vt_tam_1000_3.length-1);
        exibeOrdenado(vt_tam_1000_3);
        count_Quick_1000 += quickSort(vt_tam_1000_4, 0,vt_tam_1000_4.length-1);
        exibeOrdenado(vt_tam_1000_4);
        count_Quick_1000 += quickSort(vt_tam_1000_5, 0,vt_tam_1000_5.length-1);
        exibeOrdenado(vt_tam_1000_5);
        count_Quick_1000 += quickSort(vt_tam_1000_6, 0,vt_tam_1000_6.length-1);
        exibeOrdenado(vt_tam_1000_6);
        count_Quick_1000 += quickSort(vt_tam_1000_7, 0,vt_tam_1000_7.length-1);
        exibeOrdenado(vt_tam_1000_7);
        count_Quick_1000 += quickSort(vt_tam_1000_8, 0,vt_tam_1000_8.length-1);
        exibeOrdenado(vt_tam_1000_8);

        // Array[10000]
        System.out.println("----------------ARRAY[10000]-------------------");
        count_Quick_10000 += quickSort(vt_tam_10000_1, 0,vt_tam_10000_1.length-1);
        exibeOrdenado(vt_tam_10000_1);
        count_Quick_10000 += quickSort(vt_tam_10000_2, 0,vt_tam_10000_2.length-1);
        exibeOrdenado(vt_tam_10000_2);
        count_Quick_10000 += quickSort(vt_tam_10000_3, 0,vt_tam_10000_3.length-1);
        exibeOrdenado(vt_tam_10000_3);
        count_Quick_10000 += quickSort(vt_tam_10000_4, 0,vt_tam_10000_4.length-1);
        exibeOrdenado(vt_tam_10000_4);
        count_Quick_10000 += quickSort(vt_tam_10000_5, 0,vt_tam_10000_5.length-1);
        exibeOrdenado(vt_tam_10000_5);
        count_Quick_10000 += quickSort(vt_tam_10000_6, 0,vt_tam_10000_6.length-1);
        exibeOrdenado(vt_tam_10000_6);
        count_Quick_10000 += quickSort(vt_tam_10000_7, 0,vt_tam_10000_7.length-1);
        exibeOrdenado(vt_tam_10000_7);
        count_Quick_10000 += quickSort(vt_tam_10000_8, 0,vt_tam_10000_8.length-1);
        exibeOrdenado(vt_tam_10000_8);
        ...
        System.out.println("\n- Quick Sort:\n");
        System.out.println("Média de vezes executado (Array[5]): " + count_Quick_5 / 8);
        System.out.println("Média de vezes executado (Array[10]): " + count_Quick_10 / 8);
        System.out.println("Média de vezes executado (Array[50]): " + count_Quick_50 / 8);
        System.out.println("Média de vezes executado (Array[100]): " + count_Quick_100 / 8);
        System.out.println("Média de vezes executado (Array[1000]): " + count_Quick_1000 / 8);
        System.out.println("Média de vezes executado (Array[10000]): " + count_Quick_10000 / 8);
